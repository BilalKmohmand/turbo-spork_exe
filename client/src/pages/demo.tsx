...
**Generated by Gradeio Essay Writer · 850 words**
...
function DemoOverview({ setActive }: { setActive: (s: string) => void }) {
  ...
  return (
    <div className="p-8 space-y-8 max-w-4xl mx-auto">
      <div>
        <h2 className="text-2xl font-black text-white mb-1">Welcome to Gradeio 👋</h2>
...
function DemoTutor() {
  ...
  const [messages, setMessages] = useState<{ role: "user" | "ai"; text: string }[]>([
    { role: "ai", text: "👋 Hi! I'm your Gradeio AI Tutor. Ask me anything — maths problems, science questions, essay help, or any subject. I'll give you step-by-step explanations.\n\nWhat would you like to learn today?" }
  ]);
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        <div className="max-w-3xl mx-auto">
          <div className="mb-6 p-4 bg-violet-500/10 border border-violet-500/20 rounded-2xl text-[13px] text-violet-300 flex items-start gap-2.5">
            ...
            <span>In the real app, record any lecture with your microphone and Gradeio automatically generates structured notes like these. <Link href="/auth?mode=register"><span className="font-bold underline cursor-pointer">Sign up free to try it →</span></Link></span>
          </div>
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0A0A09] text-white overflow-hidden">
      ...
      <div className="bg-violet-600 text-white text-center py-2.5 px-4 flex items-center justify-center gap-3 shrink-0 text-[13px] font-medium">
        ...
        You're exploring the Gradeio demo — all features available, no account needed.
